...
Customers placed mostly medium-sized deals likely because of a lower risk and a good value compared to large deals which require higher total spend. But as we can see there is a decline in sales in 2005, where total orders dropped from 451 to 168. This decrease is mainly driven by a reduction in medium deal size orders, which fell from 268 to 85 and had previously been the main contributor to revenue.
