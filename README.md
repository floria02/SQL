...
<p>
  <img src="https://i.postimg.cc/LsTqYR3t/New-Dashboard.jpg"Alt text">
</p>
...
Customers placed mostly medium-sized deals likely because of a lower risk and a good value compared to large deals which require higher total spend. But as we can see there is a decline in sales in 2005, where total orders dropped from 451(2004) to 168. This decrease is mainly driven by a reduction in medium deal size orders, which fell from 268 to 85 and had previously been the main contributor to revenue. As we can see the reason behind the drop of the sales is not a potential increase of the price of the product lines as they actually drop through the 3 years period . 
